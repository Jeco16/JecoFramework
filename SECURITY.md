...
If you discover a security vulnerability, please report it responsibly. Do not disclose sensitive technical details in public issues.

Preferred reporting channels:

1. Use GitHub's security advisories: go to the repository's "Security" tab → "Advisories" → "Report a vulnerability" to submit a private report.
